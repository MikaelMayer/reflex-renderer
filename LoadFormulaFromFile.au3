...
Global Const Enum $BLANK_LINE = 401, $COMMENT_OR_FORMULA, $OPTIONS_LINE
Global Const Enum $FORMULA_ENTRY_TREEVIEWITEMS = 0, $FORMULA_ENTRY_IFOPTIONS, $FORMULA_ENTRY_OPTIONS, $FORMULA_ENTRY_SIZE
Global Const Enum $HAS_FORMULA, $HAS_COMMENT, $HAS_WINDOW, $HAS_RESOLUTION
Global Const Enum $FORMULA_ITEM_TYPE = 0, $FORMULA_ITEM_CONTENT0 = 1
Global Const Enum $FORMULA_ITEM_CONTENT0_KEY = 0, $FORMULA_ITEM_CONTENT0_VALUE = 1
